...
<head>
  ...
  <link rel="stylesheet" href="<?php echo url('theme'); ?>/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo url('theme'); ?>/plugins/fontawesome-free/css/all.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo url('theme'); ?>/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo url('theme'); ?>/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="<?php echo url('theme'); ?>/#" role="button"><i class="fas fa-bars"></i></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo url('theme'); ?>/index3.html" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo url('theme'); ?>/#" class="nav-link">Contact</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <li class="nav-item">
        <a class="nav-link" data-widget="navbar-search" href="<?php echo url('theme'); ?>/#" role="button">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="<?php echo url('theme'); ?>/#">
          <i class="far fa-comments"></i>
          <span class="badge badge-danger navbar-badge">3</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="<?php echo url('theme'); ?>/#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo url('theme'); ?>/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="<?php echo url('theme'); ?>/#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo url('theme'); ?>/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="<?php echo url('theme'); ?>/#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo url('theme'); ?>/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo url('theme'); ?>/#" class="dropdown-item dropdown-footer">See All Messages</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo url('theme'); ?>/#" class="dropdown-item dropdown-footer">See All Notifications</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="fullscreen" href="<?php echo url('theme'); ?>/#" role="button">
          <i class="fas fa-expand-arrows-alt"></i>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true" href="<?php echo url('theme'); ?>/#" role="button">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo url('theme'); ?>/index3.html" class="brand-link">
      <img src="<?php echo url('theme'); ?>/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Task Manager 3</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo url('theme'); ?>/#" class="d-block">{{ Auth::user()->name }}</a>
        </div>
      </div>
          ...
          <li class="nav-item menu-open">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?php echo url('summer'); ?>" class="nav-link">
              ...
              @can('user-list')
              <li class="nav-item menu-open">
                <a href="<?php echo url('userlist'); ?>/#" class="nav-link">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    User List
                  </p>
              ...
              <li class="nav-item menu-open">
                <a href="<?php echo url('permissionlist'); ?>/#" class="nav-link">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Permission List
              ...
              <li class="nav-item menu-open">
                <a href="<?php echo url('rolelist'); ?>/#" class="nav-link">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Roles List
              ...
              <li class="nav-item menu-open">
                <a href="<?php echo url('projectlist'); ?>/#" class="nav-link">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Project List
...
@yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021>Task Manager.</strong>
    All rights reserved.
